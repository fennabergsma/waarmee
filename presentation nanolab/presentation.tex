...
\exg. Zij schrijft de brief \tbf{met} een potlood.\\
 she writes the letter with a pencil\\
 `She writes the letter with a pencil.'

\pause

\exg. Zij koopt \tbf{dat}.\\
 she buys that\\
 `She buys that.'

\pause

\exg. * Zij schrijft de brief \tbf{met} \tbf{dat}.\\
 she writes the letter with that\\
 `She writes the letter with that.'

\pause

\exg. Zij schrijft de brief \tbf{daar} \tbf{mee}.\\
...
\centering{
\tbf{met dat} | \tbf{daar mee} \pause
}

\vspace{1em}

\begin{enumerate}
  \item Q: why *\tit{met dat} (but \tit{daar mee})? \pause\\
  A: \tit{daar mee} is the default, \tit{met dat} only appears under special circumstances (morphological derivation, cf. \tit{mice} and not \tit{mouse-s})\pause
  \item Q: why does the adposition change form? \pause\\
  A: \tit{mee} and \tit{met} are stored as different forms in the lexicon \pause
  \item Q: why does the adposition change position? \pause\\
  A: \tit{mee} and \tit{met} are stored as preposition or postposition in the lexicon \pause
  \item Q: why is there an \tit{r}, even though there is no location involved? \pause\\
  A: \tit{r} is ambiguous between \tsc{thing} and \tsc{location}
\end{enumerate}
...
\begin{itemize}
  \item \tit{mee} and \tit{met} are stored as different forms in the lexicon
...
\begin{itemize}
  \item \tit{mee} and \tit{met} are stored as preposition or postposition in the lexicon \pause
...
\begin{frame}{\tit{r} without location}

  \begin{itemize}
    \item \tit{r} is ambiguous between \tsc{thing} and \tsc{location}
    \item ambiguity comes from containment relations
  \end{itemize}
...
\begin{itemize}
  \item \tit{daar mee} is the default, \tit{met dat} only appears under special circumstances (morphological derivation, cf. \tit{mice} and not \tit{mouse-s}) \pause
...
\ex.
\ag. Ze heeft de brief \tbf{daar} \tbf{mee} geschreven.\\
 she has the letter there with written\\
 `She wrote the letter with that.'
\bg. Zij heeft de brief \tbf{met} \tbf{dat} potlood geschreven.\\
...
\begin{frame}{\tit{daar mee} in a proper constituent}

\exg. Ze heeft de brief \tbf{daar} \tbf{mee} geschreven.\\
 she has the letter there with written\\
 `She wrote (the letter) with that.'

\pause

\exg. \tbf{Daar} \tbf{mee} heeft ze de brief geschreven.\\
 there with has she the letter written\\
 `With that she has written the letter.' \hfill topicalization

\pause

\exg. Ze heeft de brief \tbf{hier} \tbf{mee} en \tbf{daar} \tbf{mee} geschreven.\\
...
\begin{frame}{\tit{met dat} in a non-constituent}


\exg. Ze heeft de brief \tbf{met} \tbf{dat} potlood geschreven.\\
...
\ex.
\ag. *\tbf{Met} \tbf{dat} heeft ze de brief \tbf{potlood} geschreven.\\
 with that has she the letter pencil written\\
 `With that pencil she has written the letter.'
\bg. \tbf{Met} \tbf{dat} \tbf{potlood} heeft ze de brief geschreven.\\
...
% \ex.
% \ag. *Ze heeft de brief met die en met dat potlood geschreven.\\
%  she has the letter with this and with that pencil written\\
%  `She has written the letter with this pencil and with that marker.' \hfill coordination
% \bg. Ze heeft de brief met die pen en en dat potlood geschreven.\\
%  she has the letter with this marker and with that pencil written\\
%  `She has written the letter with this pencil and with that marker.' \hfill coordination
%
% \pause
...
[\tsc{insP}
    ...
    [\tsc{datP}
        ...
        {\draw (.east) node[right]{⇒ \tit{potlood}}; }
    ]
]
    \end{forest}
