...
%%no complementary distribution in Bulgarian! So different! Nelli =b-example
...
that word is unfamiliar to me -\tsc{acc/dat.full}\\
...
%%Maybe save the day: in Dutch you can also use \tit{dat} in that position. So here is another difference between Bulgarian and Dutch: not with clitics, but with weak pronouns
