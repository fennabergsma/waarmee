...
I start at the point on which \tit{wat} `what' is part of a syntactic structure with the rest of a relative clause as a sister.
...
After that, \tsc{f4} is merged. here
