...
What this shows is that in principle \tit{waarmee} is used, it is the default. There is something special about the examples in which \tit{met wat} is used.
...
Now I repeat the \tit{met wat} example.
...
How do I connect constituency and different spellouts of the instrumental? Nano: only constituents can spellout. Something interevened. More examples of that.
